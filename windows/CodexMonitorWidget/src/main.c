...
static void draw_status_indicator(HDC hdc, const RECT *rect, const char *status, COLORREF row_background) {
    if (is_running_status(status)) {
        ...
        int shadow_spread;
        int field_alpha = 170 + pulse * 80 / 100;
        int field_brightness = 48 + pulse * 112 / 100;
...
static void draw_empty_state_indicator(HDC hdc, const RECT *rect, COLORREF row_background) {
    ...
    if (empty_state_is_connecting()) {
        ...
        int shadow_spread;
        int field_alpha = 150 + pulse * 70 / 100;
        int field_brightness = 28 + pulse * 38 / 100;
        COLORREF highlight_color = RGB(239, 217, 171);
        COLORREF field_color = blend_color(highlight_color, color, field_brightness);
