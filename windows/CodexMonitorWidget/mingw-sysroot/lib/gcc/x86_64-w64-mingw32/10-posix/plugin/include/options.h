...
enum opt_code
{
  ...
  OPT_Wpedantic_cast = 615,                  /* -Wpedantic-cast */
  OPT_Wpedantic_ms_format = 616,             /* -Wpedantic-ms-format */
  OPT_Wpedantic_param_names = 617,           /* -Wpedantic-param-names */
  ...
  OPT_Wverbose_unbounded = 737,              /* -Wverbose-unbounded */
  OPT_Wvirtual_inheritance = 738,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 739,            /* -Wvirtual-move-assign */
  OPT_Wvla = 740,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 741,               /* -Wvla-larger-than= */
  OPT_Wvolatile = 742,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 743,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 744,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 745,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 746,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 747,                       /* -Wzerotrip */
  OPT_X = 748,                               /* -X */
  OPT_Xassembler = 749,                      /* -Xassembler */
  OPT_Xf = 750,                              /* -Xf */
  OPT_Xlinker = 751,                         /* -Xlinker */
  OPT_Xpreprocessor = 752,                   /* -Xpreprocessor */
  OPT_Z = 753,                               /* -Z */
  OPT_ansi = 754,                            /* -ansi */
  OPT_aux_info = 755,                        /* -aux-info */
  /* OPT_aux_info_ = 756, */                 /* -aux-info= */
  OPT_auxbase = 757,                         /* -auxbase */
  OPT_auxbase_strip = 758,                   /* -auxbase-strip */
  OPT_c = 759,                               /* -c */
  OPT_callgraph = 760,                       /* -callgraph */
  OPT_coverage = 761,                        /* -coverage */
  OPT_cpp = 762,                             /* -cpp */
  OPT_cpp_ = 763,                            /* -cpp= */
  OPT_d = 764,                               /* -d */
  OPT_debuglib_ = 765,                       /* -debuglib= */
  OPT_defaultlib_ = 766,                     /* -defaultlib= */
  OPT_defined_only = 767,                    /* -defined-only */
  OPT_demangle = 768,                        /* -demangle */
  OPT_dstartfiles = 769,                     /* -dstartfiles */
  OPT_dump_body_ = 770,                      /* -dump-body= */
  OPT_dump_level_ = 771,                     /* -dump-level= */
  OPT_dumpbase = 772,                        /* -dumpbase */
  OPT_dumpdir = 773,                         /* -dumpdir */
  OPT_dumpfullversion = 774,                 /* -dumpfullversion */
  OPT_dumpmachine = 775,                     /* -dumpmachine */
  OPT_dumpspecs = 776,                       /* -dumpspecs */
  OPT_dumpversion = 777,                     /* -dumpversion */
  OPT_e = 778,                               /* -e */
  OPT_export_dynamic = 779,                  /* -export-dynamic */
  OPT_fPIC = 780,                            /* -fPIC */
  OPT_fPIE = 781,                            /* -fPIE */
  OPT_fRTS_ = 782,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 783,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 784,                   /* -fabi-version= */
  OPT_faccess_control = 785,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 786,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 787,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 788,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 789,                  /* -falign-commons */
  OPT_falign_functions = 790,                /* -falign-functions */
  OPT_falign_functions_ = 791,               /* -falign-functions= */
  OPT_falign_jumps = 792,                    /* -falign-jumps */
  OPT_falign_jumps_ = 793,                   /* -falign-jumps= */
  OPT_falign_labels = 794,                   /* -falign-labels */
  OPT_falign_labels_ = 795,                  /* -falign-labels= */
  OPT_falign_loops = 796,                    /* -falign-loops */
  OPT_falign_loops_ = 797,                   /* -falign-loops= */
  /* OPT_faligned_new = 798, */              /* -faligned-new */
  OPT_faligned_new_ = 799,                   /* -faligned-new= */
  OPT_fall_instantiations = 800,             /* -fall-instantiations */
  OPT_fall_intrinsics = 801,                 /* -fall-intrinsics */
  OPT_fall_virtual = 802,                    /* -fall-virtual */
  OPT_fallocation_dce = 803,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 804,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 805,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 806,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 807,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 808,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 809,         /* -falt-external-templates */
  OPT_fanalyzer = 810,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 811,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 812,              /* -fanalyzer-checker= */
  OPT_fanalyzer_fine_grained = 813,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 814,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 815,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 816,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 817,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 818,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 819, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 820,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 821, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 822, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 823, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 824, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 825,            /* -fasan-shadow-offset= */
  OPT_fasm = 826,                            /* -fasm */
  OPT_fassert = 827,                         /* -fassert */
  OPT_fassociative_math = 828,               /* -fassociative-math */
  OPT_fassume_phsa = 829,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 830,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 831,                   /* -fauto-inc-dec */
  OPT_fauto_init = 832,                      /* -fauto-init */
  OPT_fauto_profile = 833,                   /* -fauto-profile */
  OPT_fauto_profile_ = 834,                  /* -fauto-profile= */
  OPT_fautomatic = 835,                      /* -fautomatic */
  OPT_fbackslash = 836,                      /* -fbackslash */
  OPT_fbacktrace = 837,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 838,             /* -fblas-matmul-limit= */
  OPT_fbounds = 839,                         /* -fbounds */
  OPT_fbounds_check = 840,                   /* -fbounds-check */
  OPT_fbounds_check_ = 841,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 842,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 843,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 844, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 845, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 846, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 847,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 848,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 849,                        /* -fbuiltin */
  OPT_fbuiltin_ = 850,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 851,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 852,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 853,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 854,                    /* -fcall-saved- */
  OPT_fcall_used_ = 855,                     /* -fcall-used- */
  OPT_fcaller_saves = 856,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 857,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 858,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 859,       /* -fcanonical-system-headers */
  OPT_fcase = 860,                           /* -fcase */
  /* OPT_fcf_protection = 861, */            /* -fcf-protection */
  OPT_fcf_protection_ = 862,                 /* -fcf-protection= */
  OPT_fchar8_t = 863,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 864,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 865, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 866,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 867,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 868,                         /* -fcheck= */
  OPT_fchecking = 869,                       /* -fchecking */
  OPT_fchecking_ = 870,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 871,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 872,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 873,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 874,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 875,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 876,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 877,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 878,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 879, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 880,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 881,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 882,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 883, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 884,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 885,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 886,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 887,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 888,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 889, */                 /* -fcilkplus */
  OPT_fcoarray_ = 890,                       /* -fcoarray= */
  OPT_fcode_hoisting = 891,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 892,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 893,                         /* -fcommon */
  OPT_fcompare_debug = 894,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 895,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 896,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 897,                   /* -fcompare-elim */
  OPT_fconcepts = 898,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 899,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 900,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 901,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 902, */           /* -fconserve-space */
  OPT_fconserve_stack = 903,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 904,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 905,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 906,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 907,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 908,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 909,                       /* -fconvert= */
  OPT_fcoroutines = 910,                     /* -fcoroutines */
  OPT_fcpp = 911,                            /* -fcpp */
  OPT_fcppbegin = 912,                       /* -fcppbegin */
  OPT_fcppend = 913,                         /* -fcppend */
  OPT_fcppprog_ = 914,                       /* -fcppprog= */
  OPT_fcprop_registers = 915,                /* -fcprop-registers */
  OPT_fcray_pointer = 916,                   /* -fcray-pointer */
  OPT_fcrossjumping = 917,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 918,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 919, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 920,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 921,               /* -fcx-limited-range */
  OPT_fd = 922,                              /* -fd */
  OPT_fd_lines_as_code = 923,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 924,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 925,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 926,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 927,                       /* -fdbg-cnt= */
  OPT_fdce = 928,                            /* -fdce */
  OPT_fdebug = 929,                          /* -fdebug */
  OPT_fdebug_builtins = 930,                 /* -fdebug-builtins */
  OPT_fdebug_cpp = 931,                      /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 932,    /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 933,              /* -fdebug-prefix-map= */
  OPT_fdebug_trace_api = 934,                /* -fdebug-trace-api */
  OPT_fdebug_trace_quad = 935,               /* -fdebug-trace-quad */
  OPT_fdebug_types_section = 936,            /* -fdebug-types-section */
  OPT_fdebug_ = 937,                         /* -fdebug= */
  OPT_fdec = 938,                            /* -fdec */
  OPT_fdec_blank_format_item = 939,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 940,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 941,            /* -fdec-format-defaults */
  OPT_fdec_include = 942,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 943,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 944,                       /* -fdec-math */
  OPT_fdec_static = 945,                     /* -fdec-static */
  OPT_fdec_structure = 946,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 947,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 948, */         /* -fdeduce-init-list */
  OPT_fdef_ = 949,                           /* -fdef= */
  OPT_fdefault_double_8 = 950,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 951, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 952,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 953,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 954,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 955,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 956,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 957,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 958,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 959,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 960,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 961,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 962,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 963, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 964,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 965,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 966,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 967,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 968,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 969,       /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_show_caret = 970,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 971,           /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 972,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 973,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 974,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 975,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 976,   /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 977, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 978,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 979,                /* -fdirectives-only */
  OPT_fdisable_ = 980,                       /* -fdisable- */
  OPT_fdoc = 981,                            /* -fdoc */
  OPT_fdoc_dir_ = 982,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 983,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 984,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 985,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 986,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 987,                       /* -fdruntime */
  OPT_fdse = 988,                            /* -fdse */
  OPT_fdump_ = 989,                          /* -fdump- */
  OPT_fdump_ada_spec = 990,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 991,             /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 992,                  /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 993,        /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 994,   /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 995,   /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 996, /* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 997, /* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_state_purge = 998,      /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 999,           /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1000,      /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 1001, */               /* -fdump-core */
  OPT_fdump_d_original = 1002,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1003,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1004,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1005,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1006,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1007,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1008,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1009,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1010,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1011, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1012,                   /* -fdump-passes */
  OPT_fdump_scos = 1013,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1014,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1015,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1016,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1017,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1018,                /* -fearly-inlining */
  OPT_felide_constructors = 1019,            /* -felide-constructors */
  OPT_felide_type = 1020,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1021, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1022,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1023,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1024,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1025,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1026,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1027,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1028,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1029,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1030,                /* -fenum-int-equiv */
  OPT_fexceptions = 1031,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1032,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1033,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1034,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1035,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1036,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1037,               /* -fextended-opaque */
  OPT_fextern_tls_init = 1038,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1039,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1040,            /* -fexternal-templates */
  OPT_ff2c = 1041,                           /* -ff2c */
  OPT_ffast_math = 1042,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1043,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1044,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1045,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1046,              /* -ffinite-math-only */
  OPT_ffixed_ = 1047,                        /* -ffixed- */
  OPT_ffixed_form = 1048,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1049,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1050,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1051,                   /* -ffloat-store */
  OPT_ffloatvalue = 1052,                    /* -ffloatvalue */
  OPT_ffor_scope = 1053,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1054, */              /* -fforce-addr */
  OPT_fforward_propagate = 1055,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1056,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1057,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1058,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1059,                     /* -ffpe-trap= */
  OPT_ffree_form = 1060,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1061,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1062,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1063,                  /* -ffreestanding */
  OPT_ffriend_injection = 1064,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1065,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1066,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1067,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1068,             /* -ffunction-sections */
  OPT_fgcse = 1069,                          /* -fgcse */
  OPT_fgcse_after_reload = 1070,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1071,                      /* -fgcse-las */
  OPT_fgcse_lm = 1072,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1073,                       /* -fgcse-sm */
  OPT_fgimple = 1074,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1075,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1076,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1077,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1078,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1079,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1080,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1081,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1082,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1083,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1084,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1085,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1086,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1087,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1088,                      /* -fgo-dump- */
  OPT_fgo_optimize_ = 1089,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1090,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1091,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1092,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1093,                      /* -fgraphite */
  OPT_fgraphite_identity = 1094,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1095,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1096,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1097, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1098, */                    /* -fhelp */
  /* OPT_fhelp_ = 1099, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1100,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1101,                     /* -fhonor-std */
  OPT_fhosted = 1102,                        /* -fhosted */
  OPT_fhuge_objects = 1103,                  /* -fhuge-objects */
  OPT_fident = 1104,                         /* -fident */
  OPT_fif_conversion = 1105,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1106,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1107,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1108,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1109,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1110,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1111,            /* -fimplicit-templates */
  OPT_findex = 1112,                         /* -findex */
  OPT_findirect_inlining = 1113,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1114,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1115,               /* -finit-character= */
  OPT_finit_derived = 1116,                  /* -finit-derived */
  OPT_finit_integer_ = 1117,                 /* -finit-integer= */
  OPT_finit_local_zero = 1118,               /* -finit-local-zero */
  OPT_finit_logical_ = 1119,                 /* -finit-logical= */
  OPT_finit_real_ = 1120,                    /* -finit-real= */
  OPT_finline = 1121,                        /* -finline */
  OPT_finline_arg_packing = 1122,            /* -finline-arg-packing */
  OPT_finline_atomics = 1123,                /* -finline-atomics */
  OPT_finline_functions = 1124,              /* -finline-functions */
  OPT_finline_functions_called_once = 1125,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1126, */           /* -finline-limit- */
  OPT_finline_limit_ = 1127,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1128,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1129,        /* -finline-small-functions */
  OPT_finput_charset_ = 1130,                /* -finput-charset= */
  OPT_finstrument_functions = 1131,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1132,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1133,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1134,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1135,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1136,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1137,                    /* -finvariants */
  OPT_fipa_bit_cp = 1138,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1139,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1140, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1141,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1142,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1143,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1144,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1145, */        /* -fipa-matrix-reorg */
  OPT_fipa_profile = 1146,                   /* -fipa-profile */
  OPT_fipa_pta = 1147,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1148,                /* -fipa-pure-const */
  OPT_fipa_ra = 1149,                        /* -fipa-ra */
  OPT_fipa_reference = 1150,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1151,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1152,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1153,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1154, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1155,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1156,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1157,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1158,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1159,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1160,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1161,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1162,                  /* -fira-verbose= */
  OPT_fiso = 1163,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1164,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1165,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1166,              /* -fivar-visibility= */
  OPT_fivopts = 1167,                        /* -fivopts */
  OPT_fjump_tables = 1168,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1169,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1170,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1171,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1172,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1173,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1174,                     /* -flabels-ok */
  OPT_flax_vector_conversions = 1175,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1176,            /* -fleading-underscore */
  OPT_flibs_ = 1177,                         /* -flibs= */
  OPT_flifetime_dse = 1178,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1179,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1180,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1181,                /* -flinker-output= */
  /* OPT_flive_patching = 1182, */           /* -flive-patching */
  OPT_flive_patching_ = 1183,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1184,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1185,                   /* -flocal-ivars */
  OPT_flocation_ = 1186,                     /* -flocation= */
  /* OPT_floop_block = 1187, */              /* -floop-block */
  /* OPT_floop_flatten = 1188, */            /* -floop-flatten */
  OPT_floop_interchange = 1189,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1190,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1191, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1192,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1193, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1194,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1195,                     /* -flra-remat */
  OPT_flto = 1196,                           /* -flto */
  OPT_flto_compression_level_ = 1197,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1198, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1199,                /* -flto-partition= */
  OPT_flto_report = 1200,                    /* -flto-report */
  OPT_flto_report_wpa = 1201,                /* -flto-report-wpa */
  OPT_flto_ = 1202,                          /* -flto= */
  OPT_fltrans = 1203,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1204,           /* -fltrans-output-list= */
  OPT_fm2_g = 1205,                          /* -fm2-g */
  OPT_fm2_lower_case = 1206,                 /* -fm2-lower-case */
  OPT_fm2_plugin = 1207,                     /* -fm2-plugin */
  OPT_fm2_statistics = 1208,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1209,                /* -fm2-strict-type */
  OPT_fm2_version = 1210,                    /* -fm2-version */
  OPT_fm2_whole_program = 1211,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1212,             /* -fmacro-prefix-map= */
  OPT_fmain = 1213,                          /* -fmain */
  OPT_fmakeinit = 1214,                      /* -fmakeinit */
  OPT_fmakelist = 1215,                      /* -fmakelist */
  OPT_fmath_errno = 1216,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1217,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1218,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1219,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1220,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1221,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1222,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1223,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1224,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1225,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1226,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1227,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1228,               /* -fmessage-length= */
  OPT_fmod_ = 1229,                          /* -fmod= */
  OPT_fmodule_file_ = 1230,                  /* -fmodule-file= */
  OPT_fmodule_private = 1231,                /* -fmodule-private */
  OPT_fmoduleinfo = 1232,                    /* -fmoduleinfo */
  OPT_fmodules = 1233,                       /* -fmodules */
  OPT_fmodulo_sched = 1234,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1235,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1236,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1237,                 /* -fms-extensions */
  OPT_fmudflap = 1238,                       /* -fmudflap */
  OPT_fmudflapir = 1239,                     /* -fmudflapir */
  OPT_fmudflapth = 1240,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1241,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1242,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1243,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1244,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1245,                  /* -fnext-runtime */
  OPT_fnil = 1246,                           /* -fnil */
  OPT_fnil_receivers = 1247,                 /* -fnil-receivers */
  OPT_fno_m2_plugin = 1248,                  /* -fno-m2-plugin */
  OPT_fno_pthread = 1249,                    /* -fno-pthread */
  ...
  OPT_fobject_path_ = 1262,                  /* -fobject-path= */
  OPT_foffload_abi_ = 1263,                  /* -foffload-abi= */
  OPT_foffload_ = 1264,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1265,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1266,                         /* -fonly= */
  OPT_fonlylink = 1267,                      /* -fonlylink */
  OPT_fopenacc = 1268,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1269,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1270,                        /* -fopenmp */
  OPT_fopenmp_simd = 1271,                   /* -fopenmp-simd */
  OPT_foperator_names = 1272,                /* -foperator-names */
  OPT_fopt_info = 1273,                      /* -fopt-info */
  OPT_fopt_info_ = 1274,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1275, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1276,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1277,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1278, */          /* -foptional-diags */
  OPT_fpack_derived = 1279,                  /* -fpack-derived */
  OPT_fpack_struct = 1280,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1281,                  /* -fpack-struct= */
  OPT_fpad_source = 1282,                    /* -fpad-source */
  OPT_fpartial_inlining = 1283,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1284,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1285,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1286,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1287,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1288,                    /* -fpeel-loops */
  OPT_fpeephole = 1289,                      /* -fpeephole */
  OPT_fpeephole2 = 1290,                     /* -fpeephole2 */
  OPT_fpermissive = 1291,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1292,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1293,                           /* -fpic */
  OPT_fpie = 1294,                           /* -fpie */
  OPT_fpim = 1295,                           /* -fpim */
  OPT_fpim2 = 1296,                          /* -fpim2 */
  OPT_fpim3 = 1297,                          /* -fpim3 */
  OPT_fpim4 = 1298,                          /* -fpim4 */
  OPT_fplan9_extensions = 1299,              /* -fplan9-extensions */
  OPT_fplt = 1300,                           /* -fplt */
  OPT_fplugin_arg_ = 1301,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1302,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1303,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1304,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1305,                /* -fpostconditions */
  OPT_fpre_include_ = 1306,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1307,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1308,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1309,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1310,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1311,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1312,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1313,           /* -fprintf-return-value */
  OPT_fprofile = 1314,                       /* -fprofile */
  OPT_fprofile_abs_path = 1315,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1316,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1317,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1318,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1319,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1320,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1321,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1322,             /* -fprofile-generate= */
  ...
  OPT_fprofile_reproducible_ = 1328,         /* -fprofile-reproducible= */
  ...
  OPT_fq = 1334,                             /* -fq */
  OPT_frandom_seed = 1335,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1336,                  /* -frandom-seed= */
  OPT_frange = 1337,                         /* -frange */
  OPT_frange_check = 1338,                   /* -frange-check */
  OPT_freal_4_real_10 = 1339,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1340,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1341,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1342,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1343,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1344,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1345,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1346,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1347,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1348,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1349,               /* -frecord-marker=8 */
  OPT_frecursive = 1350,                     /* -frecursive */
  OPT_free = 1351,                           /* -free */
  OPT_freg_struct_return = 1352,             /* -freg-struct-return */
  /* OPT_fregmove = 1353, */                 /* -fregmove */
  OPT_frelease = 1354,                       /* -frelease */
  OPT_frename_registers = 1355,              /* -frename-registers */
  OPT_freorder_blocks = 1356,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1357,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1358,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1359,             /* -freorder-functions */
  OPT_frepack_arrays = 1360,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1361,          /* -freplace-objc-classes */
  OPT_frepo = 1362,                          /* -frepo */
  OPT_freport_bug = 1363,                    /* -freport-bug */
  OPT_frequire_return_statement = 1364,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1365,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1366, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1367,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1368,                   /* -fresolution= */
  OPT_freturn = 1369,                        /* -freturn */
  OPT_frounding_math = 1370,                 /* -frounding-math */
  OPT_frtti = 1371,                          /* -frtti */
  OPT_fruntime_modules_ = 1372,              /* -fruntime-modules= */
  OPT_fsanitize_address_use_after_scope = 1373,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1374,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1375,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1376,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1377,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1378,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1379,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1380,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1381, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1382,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1383,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1384,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1385,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1386,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1387,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1388,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1389,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1390,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1391,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1392,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1393,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1394,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1395,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1396,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1397,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1398, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1399,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1400,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1401,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1402,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1403,               /* -fsection-anchors */
  /* OPT_fsee = 1404, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1405,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1406,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1407,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1408,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1409,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1410,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1411,        /* -fsemantic-interposition */
  OPT_fset_stack_executable = 1412,          /* -fset-stack-executable */
  OPT_fshared = 1413,                        /* -fshared */
  OPT_fshort_enums = 1414,                   /* -fshort-enums */
  OPT_fshort_wchar = 1415,                   /* -fshort-wchar */
  OPT_fshow_column = 1416,                   /* -fshow-column */
  OPT_fshrink_wrap = 1417,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1418,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1419,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1420,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1421,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1422,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1423,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1424,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1425,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1426,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1427,                /* -fsoft-check-all */
  OPT_fsources = 1428,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1429,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1430,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1431,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1432,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1433,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1434,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1435,                      /* -fsquangle */
  OPT_fssa_backprop = 1436,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1437,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1438,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1439,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1440, */             /* -fstack-check */
  OPT_fstack_check_ = 1441,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1442,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1443,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1444,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1445,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1446,               /* -fstack-protector */
  OPT_fstack_protector_all = 1447,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1448,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1449,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1450,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1451,                   /* -fstack-usage */
  OPT_fstats = 1452,                         /* -fstats */
  OPT_fstdarg_opt = 1453,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1454,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1455, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1456,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1457,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1458,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1459,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1460,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1461, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1462,            /* -fstrong-eval-order= */
  OPT_fswig = 1463,                          /* -fswig */
  OPT_fswitch_errors = 1464,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1465,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1466,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1467,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1468, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1469,         /* -ftail-call-workaround= */
  OPT_ftarget_ar_ = 1470,                    /* -ftarget-ar= */
  /* OPT_ftarget_help = 1471, */             /* -ftarget-help */
  OPT_ftarget_ranlib_ = 1472,                /* -ftarget-ranlib= */
  OPT_ftemplate_backtrace_limit_ = 1473,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1474, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1475,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1476,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1477,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1478,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1479,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1480,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1481,                   /* -ftime-report */
  OPT_ftime_report_details = 1482,           /* -ftime-report-details */
  OPT_ftls_model_ = 1483,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1484,              /* -ftoplevel-reorder */
  OPT_ftracer = 1485,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1486,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1487,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1488,                   /* -ftrampolines */
  OPT_ftransition_all = 1489,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1490,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1491,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1492,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1493,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1494,              /* -ftransition=field */
  OPT_ftransition_import = 1495,             /* -ftransition=import */
  OPT_ftransition_nogc = 1496,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1497,                /* -ftransition=tls */
  OPT_ftrapping_math = 1498,                 /* -ftrapping-math */
  OPT_ftrapv = 1499,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1500,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1501,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1502,                      /* -ftree-ccp */
  OPT_ftree_ch = 1503,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1504, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1505,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1506,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1507, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1508,                   /* -ftree-cselim */
  OPT_ftree_dce = 1509,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1510,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1511,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1512,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1513,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1514, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1515,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1516,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1517, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1518,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1519,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1520, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1521,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1522,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1523,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1524,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1525,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1526,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1527,                      /* -ftree-pre */
  OPT_ftree_pta = 1528,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1529,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1530, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1531,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1532,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1533,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1534,                     /* -ftree-slsr */
  OPT_ftree_sra = 1535,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1536, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1537, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1538,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1539,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1540,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1541, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1542,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1543, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1544,                      /* -ftree-vrp */
  OPT_funbounded_by_reference = 1545,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1546,         /* -funconstrained-commons */
  OPT_funderscoring = 1547,                  /* -funderscoring */
  OPT_funit_at_a_time = 1548,                /* -funit-at-a-time */
  OPT_funittest = 1549,                      /* -funittest */
  OPT_funroll_all_loops = 1550,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1551,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1552,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1553, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1554,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1555,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1556,                 /* -funsigned-char */
  OPT_funswitch_loops = 1557,                /* -funswitch-loops */
  OPT_funwind_tables = 1558,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1559,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1560,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1561,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1562,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1563,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1564,             /* -fuse-linker-plugin */
  OPT_fuselist = 1565,                       /* -fuselist */
  OPT_fvar_tracking = 1566,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1567,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1568,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1569,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1570,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1571, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1572,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1573,                   /* -fverbose-asm */
  /* OPT_fversion = 1574, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1575,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1576,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1577,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1578,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1579,                   /* -fvisibility= */
  OPT_fvpt = 1580,                           /* -fvpt */
  OPT_fvtable_gc = 1581,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1582,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1583,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1584,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1585,                     /* -fvtv-debug */
  OPT_fweak = 1586,                          /* -fweak */
  OPT_fweb = 1587,                           /* -fweb */
  /* OPT_fwhole_file = 1588, */              /* -fwhole-file */
  OPT_fwhole_program = 1589,                 /* -fwhole-program */
  OPT_fwholediv = 1590,                      /* -fwholediv */
  OPT_fwholevalue = 1591,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1592,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1593,             /* -fworking-directory */
  OPT_fwpa = 1594,                           /* -fwpa */
  OPT_fwpa_ = 1595,                          /* -fwpa= */
  OPT_fwrapv = 1596,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1597,                 /* -fwrapv-pointer */
  OPT_fwritable_relocated_rdata = 1598,      /* -fwritable-relocated-rdata */
  OPT_fxcode = 1599,                         /* -fxcode */
  OPT_fxref = 1600,                          /* -fxref */
  /* OPT_fzee = 1601, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1602,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1603,                     /* -fzero-link */
  OPT_g = 1604,                              /* -g */
  OPT_gant = 1605,                           /* -gant */
  OPT_gas_loc_support = 1606,                /* -gas-loc-support */
  OPT_gas_locview_support = 1607,            /* -gas-locview-support */
  OPT_gcoff = 1608,                          /* -gcoff */
  OPT_gcoff1 = 1609,                         /* -gcoff1 */
  OPT_gcoff2 = 1610,                         /* -gcoff2 */
  OPT_gcoff3 = 1611,                         /* -gcoff3 */
  OPT_gcolumn_info = 1612,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1613,                 /* -gdescribe-dies */
  OPT_gdwarf = 1614,                         /* -gdwarf */
  OPT_gdwarf_ = 1615,                        /* -gdwarf- */
  OPT_gen_decls = 1616,                      /* -gen-decls */
  OPT_ggdb = 1617,                           /* -ggdb */
  OPT_ggnu_pubnames = 1618,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1619,                   /* -gimple-stats */
  OPT_ginline_points = 1620,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1621, /* -ginternal-reset-location-views */
  OPT_gnat = 1622,                           /* -gnat */
  OPT_gnatO = 1623,                          /* -gnatO */
  OPT_gno_ = 1624,                           /* -gno- */
  OPT_gno_pubnames = 1625,                   /* -gno-pubnames */
  OPT_gpubnames = 1626,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1627,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1628,                   /* -gsplit-dwarf */
  OPT_gstabs = 1629,                         /* -gstabs */
  OPT_gstabs_ = 1630,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1631,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1632,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1633,                        /* -gtoggle */
  OPT_gvariable_location_views = 1634,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1635,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1636,                           /* -gvms */
  OPT_gxcoff = 1637,                         /* -gxcoff */
  OPT_gxcoff_ = 1638,                        /* -gxcoff+ */
  OPT_gz = 1639,                             /* -gz */
  OPT_gz_ = 1640,                            /* -gz= */
  OPT_h = 1641,                              /* -h */
  OPT_help = 1642,                           /* -help */
  OPT_idirafter = 1643,                      /* -idirafter */
  OPT_imacros = 1644,                        /* -imacros */
  OPT_imultiarch = 1645,                     /* -imultiarch */
  OPT_imultilib = 1646,                      /* -imultilib */
  OPT_include = 1647,                        /* -include */
  OPT_iplugindir_ = 1648,                    /* -iplugindir= */
  OPT_iprefix = 1649,                        /* -iprefix */
  OPT_iquote = 1650,                         /* -iquote */
  OPT_isysroot = 1651,                       /* -isysroot */
  OPT_isystem = 1652,                        /* -isystem */
  OPT_iwithprefix = 1653,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1654,              /* -iwithprefixbefore */
  OPT_k8 = 1655,                             /* -k8 */
  OPT_l = 1656,                              /* -l */
  OPT_lang_asm = 1657,                       /* -lang-asm */
  OPT_list = 1658,                           /* -list */
  OPT_m128bit_long_double = 1659,            /* -m128bit-long-double */
  OPT_m16 = 1660,                            /* -m16 */
  OPT_m32 = 1661,                            /* -m32 */
  OPT_m3dnow = 1662,                         /* -m3dnow */
  OPT_m3dnowa = 1663,                        /* -m3dnowa */
  OPT_m64 = 1664,                            /* -m64 */
  OPT_m80387 = 1665,                         /* -m80387 */
  OPT_m8bit_idiv = 1666,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1667,             /* -m96bit-long-double */
  OPT_mabi_ = 1668,                          /* -mabi= */
  OPT_mabm = 1669,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1670,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1671,                 /* -maddress-mode= */
  OPT_madx = 1672,                           /* -madx */
  OPT_maes = 1673,                           /* -maes */
  OPT_malign_data_ = 1674,                   /* -malign-data= */
  OPT_malign_double = 1675,                  /* -malign-double */
  OPT_malign_functions_ = 1676,              /* -malign-functions= */
  OPT_malign_jumps_ = 1677,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1678,                  /* -malign-loops= */
  OPT_malign_stringops = 1679,               /* -malign-stringops */
  OPT_march_ = 1680,                         /* -march= */
  OPT_masm_ = 1681,                          /* -masm= */
  OPT_mavx = 1682,                           /* -mavx */
  OPT_mavx2 = 1683,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1684,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1685,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1686,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1687,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1688,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1689,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1690,                      /* -mavx512bw */
  OPT_mavx512cd = 1691,                      /* -mavx512cd */
  OPT_mavx512dq = 1692,                      /* -mavx512dq */
  OPT_mavx512er = 1693,                      /* -mavx512er */
  OPT_mavx512f = 1694,                       /* -mavx512f */
  OPT_mavx512ifma = 1695,                    /* -mavx512ifma */
  OPT_mavx512pf = 1696,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1697,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1698,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1699,                      /* -mavx512vl */
  OPT_mavx512vnni = 1700,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1701,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1702,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1703,                           /* -mbmi */
  OPT_mbmi2 = 1704,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1705,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1706,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1707,                    /* -mcet-switch */
  OPT_mcld = 1708,                           /* -mcld */
  OPT_mcldemote = 1709,                      /* -mcldemote */
  OPT_mclflushopt = 1710,                    /* -mclflushopt */
  OPT_mclwb = 1711,                          /* -mclwb */
  OPT_mclzero = 1712,                        /* -mclzero */
  OPT_mcmodel_ = 1713,                       /* -mcmodel= */
  OPT_mconsole = 1714,                       /* -mconsole */
  /* OPT_mcpu_ = 1715, */                    /* -mcpu= */
  OPT_mcrc32 = 1716,                         /* -mcrc32 */
  OPT_mcx16 = 1717,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1718,            /* -mdispatch-scheduler */
  OPT_mdll = 1719,                           /* -mdll */
  OPT_mdump_tune_features = 1720,            /* -mdump-tune-features */
  OPT_menqcmd = 1721,                        /* -menqcmd */
  OPT_mf16c = 1722,                          /* -mf16c */
  OPT_mfancy_math_387 = 1723,                /* -mfancy-math-387 */
  OPT_mfentry = 1724,                        /* -mfentry */
  OPT_mfentry_name_ = 1725,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1726,               /* -mfentry-section= */
  OPT_mfma = 1727,                           /* -mfma */
  OPT_mfma4 = 1728,                          /* -mfma4 */
  OPT_mforce_drap = 1729,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1730,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1731,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1732,                       /* -mfpmath= */
  OPT_mfsgsbase = 1733,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1734,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1735, */              /* -mfused-madd */
  OPT_mfxsr = 1736,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1737,             /* -mgeneral-regs-only */
  OPT_mgfni = 1738,                          /* -mgfni */
  OPT_mhard_float = 1739,                    /* -mhard-float */
  OPT_mhle = 1740,                           /* -mhle */
  OPT_miamcu = 1741,                         /* -miamcu */
  OPT_mieee_fp = 1742,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1743,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1744,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1745,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1746,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1747,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1748,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1749, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1750,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1751,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1752,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1753,                /* -mlong-double-80 */
  OPT_mlwp = 1754,                           /* -mlwp */
  OPT_mlzcnt = 1755,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1756,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1757,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1758,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1759,                  /* -mmitigate-rop */
  OPT_mmmx = 1760,                           /* -mmmx */
  OPT_mmovbe = 1761,                         /* -mmovbe */
  OPT_mmovdir64b = 1762,                     /* -mmovdir64b */
  OPT_mmovdiri = 1763,                       /* -mmovdiri */
  OPT_mmpx = 1764,                           /* -mmpx */
  OPT_mms_bitfields = 1765,                  /* -mms-bitfields */
  OPT_mmwaitx = 1766,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1767,            /* -mno-align-stringops */
  OPT_mno_default = 1768,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1769,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1770,                  /* -mno-push-args */
  OPT_mno_red_zone = 1771,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1772,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1773,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1774,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1775,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1776,                          /* -mpc32 */
  OPT_mpc64 = 1777,                          /* -mpc64 */
  OPT_mpc80 = 1778,                          /* -mpc80 */
  OPT_mpclmul = 1779,                        /* -mpclmul */
  OPT_mpcommit = 1780,                       /* -mpcommit */
  OPT_mpconfig = 1781,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1782,            /* -mpe-aligned-commons */
  OPT_mpku = 1783,                           /* -mpku */
  OPT_mpopcnt = 1784,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1785, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1786,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1787,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1788,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1789,                        /* -mprfchw */
  OPT_mptwrite = 1790,                       /* -mptwrite */
  OPT_mpush_args = 1791,                     /* -mpush-args */
  OPT_mrdpid = 1792,                         /* -mrdpid */
  OPT_mrdrnd = 1793,                         /* -mrdrnd */
  OPT_mrdseed = 1794,                        /* -mrdseed */
  OPT_mrecip = 1795,                         /* -mrecip */
  OPT_mrecip_ = 1796,                        /* -mrecip= */
  OPT_mrecord_mcount = 1797,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1798,                 /* -mrecord-return */
  OPT_mred_zone = 1799,                      /* -mred-zone */
  OPT_mregparm_ = 1800,                      /* -mregparm= */
  OPT_mrtd = 1801,                           /* -mrtd */
  OPT_mrtm = 1802,                           /* -mrtm */
  OPT_msahf = 1803,                          /* -msahf */
  OPT_msgx = 1804,                           /* -msgx */
  OPT_msha = 1805,                           /* -msha */
  OPT_mshstk = 1806,                         /* -mshstk */
  OPT_mskip_rax_setup = 1807,                /* -mskip-rax-setup */
  OPT_msoft_float = 1808,                    /* -msoft-float */
  OPT_msse = 1809,                           /* -msse */
  OPT_msse2 = 1810,                          /* -msse2 */
  OPT_msse2avx = 1811,                       /* -msse2avx */
  OPT_msse3 = 1812,                          /* -msse3 */
  OPT_msse4 = 1813,                          /* -msse4 */
  OPT_msse4_1 = 1814,                        /* -msse4.1 */
  OPT_msse4_2 = 1815,                        /* -msse4.2 */
  OPT_msse4a = 1816,                         /* -msse4a */
  /* OPT_msse5 = 1817, */                    /* -msse5 */
  OPT_msseregparm = 1818,                    /* -msseregparm */
  OPT_mssse3 = 1819,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1820,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1821, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1822,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1823, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1824,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1825,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1826,            /* -mstringop-strategy= */
  OPT_mstv = 1827,                           /* -mstv */
  OPT_mtbm = 1828,                           /* -mtbm */
  OPT_mthreads = 1829,                       /* -mthreads */
  OPT_mtls_dialect_ = 1830,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1831,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1832,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1833,                         /* -mtune= */
  OPT_municode = 1834,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1835,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1836,                          /* -mvaes */
  OPT_mveclibabi_ = 1837,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1838,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1839,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1840,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1841,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1842,                      /* -mwbnoinvd */
  OPT_mwin32 = 1843,                         /* -mwin32 */
  OPT_mwindows = 1844,                       /* -mwindows */
  OPT_mx32 = 1845,                           /* -mx32 */
  OPT_mxop = 1846,                           /* -mxop */
  OPT_mxsave = 1847,                         /* -mxsave */
  OPT_mxsavec = 1848,                        /* -mxsavec */
  OPT_mxsaveopt = 1849,                      /* -mxsaveopt */
  OPT_mxsaves = 1850,                        /* -mxsaves */
  OPT_n = 1851,                              /* -n */
  OPT_name_sort = 1852,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1853,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1854,              /* -no-integrated-cpp */
  OPT_no_pie = 1855,                         /* -no-pie */
  OPT_no_pthread = 1856,                     /* -no-pthread */
  OPT_nocpp = 1857,                          /* -nocpp */
  OPT_nodefaultlibs = 1858,                  /* -nodefaultlibs */
  OPT_nolibc = 1859,                         /* -nolibc */
  OPT_nophoboslib = 1860,                    /* -nophoboslib */
  OPT_nostartfiles = 1861,                   /* -nostartfiles */
  OPT_nostdinc = 1862,                       /* -nostdinc */
  OPT_nostdinc__ = 1863,                     /* -nostdinc++ */
  OPT_nostdlib = 1864,                       /* -nostdlib */
  OPT_o = 1865,                              /* -o */
  OPT_objects = 1866,                        /* -objects */
  OPT_p = 1867,                              /* -p */
  OPT_pass_exit_codes = 1868,                /* -pass-exit-codes */
  /* OPT_pedantic = 1869, */                 /* -pedantic */
  OPT_pedantic_errors = 1870,                /* -pedantic-errors */
  OPT_pg = 1871,                             /* -pg */
  OPT_pie = 1872,                            /* -pie */
  OPT_pipe = 1873,                           /* -pipe */
  OPT_posix = 1874,                          /* -posix */
  OPT_print_file_name_ = 1875,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1876,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1877,          /* -print-multi-directory */
  OPT_print_multi_lib = 1878,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1879,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1880,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1881,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1882,               /* -print-prog-name= */
  OPT_print_search_dirs = 1883,              /* -print-search-dirs */
  OPT_print_sysroot = 1884,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1885,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1886,                    /* -print-value */
  OPT_pthread = 1887,                        /* -pthread */
  ...
  OPT_static_liblsan = 1906,                 /* -static-liblsan */
  OPT_static_libmpx = 1907,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1908,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1909,               /* -static-libphobos */
  OPT_static_libstdc__ = 1910,               /* -static-libstdc++ */
  OPT_static_libtsan = 1911,                 /* -static-libtsan */
  OPT_static_libubsan = 1912,                /* -static-libubsan */
  OPT_static_pie = 1913,                     /* -static-pie */
  /* OPT_std_c__03 = 1914, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1915, */                /* -std=c++0x */
  OPT_std_c__11 = 1916,                      /* -std=c++11 */
  OPT_std_c__14 = 1917,                      /* -std=c++14 */
  OPT_std_c__17 = 1918,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1919, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1920, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1921, */                /* -std=c++20 */
  OPT_std_c__2a = 1922,                      /* -std=c++2a */
  OPT_std_c__98 = 1923,                      /* -std=c++98 */
  OPT_std_c11 = 1924,                        /* -std=c11 */
  OPT_std_c17 = 1925,                        /* -std=c17 */
  /* OPT_std_c18 = 1926, */                  /* -std=c18 */
  /* OPT_std_c1x = 1927, */                  /* -std=c1x */
  OPT_std_c2x = 1928,                        /* -std=c2x */
  /* OPT_std_c89 = 1929, */                  /* -std=c89 */
  OPT_std_c90 = 1930,                        /* -std=c90 */
  OPT_std_c99 = 1931,                        /* -std=c99 */
  /* OPT_std_c9x = 1932, */                  /* -std=c9x */
  OPT_std_f2003 = 1933,                      /* -std=f2003 */
  OPT_std_f2008 = 1934,                      /* -std=f2008 */
  OPT_std_f2008ts = 1935,                    /* -std=f2008ts */
  OPT_std_f2018 = 1936,                      /* -std=f2018 */
  OPT_std_f95 = 1937,                        /* -std=f95 */
  OPT_std_gnu = 1938,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1939, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1940, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1941,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1942,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1943,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1944, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1945, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1946, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1947,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1948,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1949,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1950,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1951, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1952, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1953,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1954, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1955,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1956,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1957, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1958, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1959,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1960, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1961, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1962, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1963, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1964, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1965,                     /* -std=legacy */
  OPT_symbol_ = 1966,                        /* -symbol= */
  OPT_symbolic = 1967,                       /* -symbolic */
  OPT_t = 1968,                              /* -t */
  OPT_time = 1969,                           /* -time */
  OPT_time_ = 1970,                          /* -time= */
  OPT_traditional = 1971,                    /* -traditional */
  OPT_traditional_cpp = 1972,                /* -traditional-cpp */
  OPT_tree_stats = 1973,                     /* -tree-stats */
  OPT_trigraphs = 1974,                      /* -trigraphs */
  OPT_type_stats = 1975,                     /* -type-stats */
  OPT_u = 1976,                              /* -u */
  OPT_undef = 1977,                          /* -undef */
  OPT_v = 1978,                              /* -v */
  OPT_version = 1979,                        /* -version */
  OPT_w = 1980,                              /* -w */
  OPT_wrapper = 1981,                        /* -wrapper */
  OPT_x = 1982,                              /* -x */
  OPT_z = 1983,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
